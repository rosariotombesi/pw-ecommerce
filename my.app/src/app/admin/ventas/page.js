  ...
  return (
    <section className="sales-report" aria-labelledby="ventas-title">
      <div className="section-heading">
        ...
        <p>Resumen administrativo de órdenes y productos vendidos.</p>
      </div>
      ...
      <section aria-labelledby="productos-vendidos">
        ...
        {reporte.totalOrdenes > reporte.ordenesConDetalle ? (
          <p className="report-note">
            El detalle por producto solo incluye órdenes creadas después de
        ...
        {reporte.productos.length > 0 ? (
          ...
          <p className="empty-state">Todavía no hay productos vendidos.</p>
        )}
      </section>

      <section aria-labelledby="ordenes-admin">
        <h2 id="ordenes-admin">Órdenes</h2>
        <div className="report-list">
