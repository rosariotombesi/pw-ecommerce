...
La app local usa variables de entorno en `my.app/.env.local`. Ese archivo no se sube a GitHub.
...
En Vercel, las mismas variables se cargan desde Project Settings > Environment Variables.
